<div align="center" style="margin-top: 20px">
  <img src="./welcome.svg" alt="Welcome" width="400">
</div>

- 💻 Работаю **Frontend разработчиком** в [студии МОСТ](https://web-most.ru)
- 🚀 Разрабатываю [Онлайн Школу будущего](https://school-of-future.online)
- 📫 Вы можете связаться со мной через **[Telegram](https://t.me/StepanovPlaton)**
- 🌐 Обо мне - https://stepanovplaton.ru

## Мои проекты:
- **[Home Server Services](https://git.stepanovplaton.ru/StepanovPlaton/HomeServerServices)**, 2026
  > Home Server Services - это полный набор сервисов в Docker для организации моего домашнего сервера!
- **[Neural Network++](https://git.stepanovplaton.ru/StepanovPlaton/NeuralNetwork)**, 2025
...
- **[Система распознавания и генерации документов автосалона "Первый километр"](https://github.com/StepanovPlaton/FirstKilometer)**, 2025
  > Автоматическая генерация договоров с использованием данных клиентов, извлечённых из отсканированных документов с помощью конвейера нейронных сетей
  >
...
- **[C3DGraphicEngine](https://git.stepanovplaton.ru/StepanovPlaton/C3DGraphicEngine)**, 2025
...
- **[Chat](https://git.stepanovplaton.ru/StepanovPlaton/Chat)**, 2025
  > Тестовое задание перед одним из собеседований. Написано за 10 часов. Анонимный мессенджер
  >
  > Frontend: TypeScript, React 19, Next.js 15 (App Router), Tailwind CSS, Yup, SWR
  > 
  > Backend: TypeScript, Nest 11, TypeORM, Swagger UI Express, PostgreSQL
- **.Torrent**, 2024
  > SSR Web-приложение для обмена .torrent файлами
  > 
  > [Frontend](https://git.stepanovplaton.ru/StepanovPlaton/torrent_frontend): TypeScript, React 18, Next.js 14 (App Router), Zod, SWR, Tailwind CSS
  >
  > [Backend](https://git.stepanovplaton.ru/StepanovPlaton/torrent_backend): Python, FastAPI, SQLAlchemy, ORM, Typer, asyncio
- **[JellyBelly Wiki](https://git.stepanovplaton.ru/StepanovPlaton/jelly_belly_wiki)**, 2024
  ...
  >
  > [Frontend](https://git.stepanovplaton.ru/StepanovPlaton/jelly_belly_wiki): TypeScript, React 18, Next.js 14 (App Router), Tailwind CSS, Zod
- **[Nand2Tetris](https://git.stepanovplaton.ru/StepanovPlaton/Nand2Tetris)**, 2024
...
- **[Расписание СамГУ](https://git.stepanovplaton.ru/StepanovPlaton/SSAU_Schedule)**, 2024
  ...
  >
  > [Android](https://git.stepanovplaton.ru/StepanovPlaton/SSAU_Schedule): Kotlin, Jetpack Compose, Material Design 3, Room, Glance, OkHttp
